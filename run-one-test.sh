...
echo "Running java -Xms800m -Xmx3g Analysis target2-mine  BasicTest  BasicTest  "$TARGETMETHOD" test"
time \
    java -Xms800m -Xmx3g Analysis target2-mine  BasicTest  BasicTest  "$TARGETMETHOD" test

#!/bin/bash

# Define the source folders
source_folder1="actual-output"
